...
const optionalEnvSchema = z.object({
  ...
  NEXT_PUBLIC_NOTIFICATIONS_COLLECTION_ID: z.string().min(1).optional(),
...
export function getEnv(): AppEnv {
  ...
  const parsed = optionalEnvSchema.parse({
    ...
    NEXT_PUBLIC_NOTIFICATIONS_COLLECTION_ID: process.env.NEXT_PUBLIC_NOTIFICATIONS_COLLECTION_ID,
