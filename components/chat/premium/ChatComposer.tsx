        ...
        <div className="relative flex items-end gap-2">
          ...
          <button
            ...
            className={cn(
              ...
              isListening ? "bg-[#76556d] text-white ring-4 ring-[#76556d]/15" : "bg-primary text-primary-foreground hover:bg-primary/90",
            )}
            aria-label={hasMessage ? "Send message" : isListening ? "Stop recording voice message" : "Record voice message"}
          >
