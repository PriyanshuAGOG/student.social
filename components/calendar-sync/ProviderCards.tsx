...
export default function ProviderCards({ feedUrl, webcalUrl }: { feedUrl: string; webcalUrl: string }) {
  const providers = [
    ...
    { name: 'Notion Calendar', description: 'Add this feed to Google or Apple first, then connect that account in Notion Calendar.', open: providerLinks.notion, icon: CalendarPlus },
